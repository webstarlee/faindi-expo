...
import { ProductProps, ProfileFeedbackProps } from "../../../../hooks/types";
import { getCurrencySymbol } from "../../../../utils/common";

interface UserFeedbacksPageProps {
  feedbacks: ProfileFeedbackProps[] | [];
}

export default function UserFeedbacksPage({
  feedbacks,
}: UserFeedbacksPageProps) {
            ...
            return (
              <View key={index} style={styles.singleFeedbackContainer}>
                <View style={styles.productImgBox}>
                  ...
                  {getCurrencySymbol(feedback.product.currency)} {feedback.product.reduced_price > 0? feedback.product.reduced_price: feedback.product.price}
                  </Text>
                </View>
