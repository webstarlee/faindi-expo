...
export default function TabCreateProductScreen() {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      handleResetForm();
      addOwnProduct(response.data.product);
      ...
      if (error?.response.status === 400) {
        //@ts-ignore
        ToastAndroid.show(Object.values(error?.response.data)[0],
          ToastAndroid.SHORT
        );
        ...
        <View style={styles.container}>
          ...
          >
            <View style={styles.formContainer}>
              ...
              <View style={styles.formGroup}>
                <TouchableOpacity
                  onPress={() => setIsRecycle((prev) => !prev)}
                  style={styles.checkboxBtn}
                >
                  <MaterialIcons
                    name={isRecycle ? "check-box" : "check-box-outline-blank"}
                    size={30}
                    color={isRecycle ? "#edaeff" : "#fff"}
                  />
